    ...
    ILogger<NetIamDataSeeder> logger) : INetIamDataSeeder
{
    ...
    private static IReadOnlyCollection<PermissionDefinition> GetDefaultPermissions()
    {
        ...
        [
            ...
            new("security.read", "Read Security Settings", "security", "read"),
            new("security.write", "Manage Security Settings", "security", "write"),
            new("setting.read", "Read System Settings", "system_setting", "read"),
            new("setting.write", "Manage System Settings", "system_setting", "write"),
            new("monitor.read", "Read Monitor Data", "monitor", "read"),
            new("monitor.write", "Manage Monitor Data", "monitor", "write"),
